...
spa.model = (function () {
  ...
  // The People model provides methods and events to manage
  // a list of people objects. Its public methods include:
  ...
  //     publishes a 'spa-login' global event.
  //   * logout()- revert the current user object to anonymous.
  //     This method publishes a 'spa-logout' global event.
  //
  // jQuery global events emitted by the People model include:
  ...
  //     if the client data is not synced with the server.
  //   * id - the unique id. This may be undefined if the
  //     object is not synced with the server.
  ...
  // The Chat model provides methods and events to manage
  // messaging. Its public methods include:
  // Its public methods are:
  //  * join() - joins the chat room.  This routine sets up
  //    the chat protocol with the server including publishers
  //    for 'spa-listchange' and 'spa-update' chat events.
  //    If the current user is anonymous, join() aborts
  //    and returns false.
  ...
  //    in the People database, the chatee is set to null.  If the
  ...
  //    is received.  An object of the form
  //    { dest_id   : <chatee_id>,
