...
spa.shell = (function () {
  ...
  // Arguments:
  //   * $container - the jquery DOM element where the application
  //     UI lives
  // Action   : Populates $container with the shell of the UI
  //   and then configures and initializes feature modules.
  //   The Shell is responsible for browser-wide events such as
  //   URI anchor changes.
  // Returns  : none
  // Throws   : none
  //
